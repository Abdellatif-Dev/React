...
const cubeMaterial3 = new THREE.MeshBasicMaterial({ color: 0x911ccc, wireframe: false }); //wireframe hya li ktkhlih ybano dok motltat
const cubeMaterial4 = new THREE.MeshBasicMaterial({ color: 0xffa254, wireframe: false }); //wireframe hya li ktkhlih ybano dok motltat
